...
module mixcolumns_88gates_depth5_fromscratch_tb;
  reg [31:0] x; wire [31:0] y; integer i, fails;
  reg [31:0] col [0:31];
  mixcolumns_88gates_depth5_fromscratch dut(.x(x), .y(y));
  initial begin
    fails = 0;
    col[0] = 32'h03010102;
    col[1] = 32'h06020204;
    ...
    if (fails == 0) $display("PASS: all 32 basis vectors correct — 88 gates, depth 5");
